  ...
  if(isset($_GET['sousin'])){
   ...
   $sousin =$_GET['sousin'];
    ...
    foreach ($result as $row) {
     ...
     $shitumon_line.="<tr><td>".$shitumon_account_id."</td><td>".$shitumon_hiduke."</td><td>".$shitumon_gaiyou."</td><td>".$shitumon_ki."</td><td>".$shitumon_jukousha."</td><td><a href='./situmon_shousai_2.php?targetID=".$shitumon_account_id."'><button type='button'>詳細</button></a></td></tr>\n";
...
if(isset($_POST['name'])){
  ...
  $shitumon_line.="<tr><td>".$shitumon_account_id."</td><td>".$shitumon_hiduke."</td><td>".$shitumon_gaiyou."</td><td>".$shitumon_ki."</td><td>".$shitumon_jukousha."</td><td><a href='./situmon_shousai_2.php?targetID=".$shitumon_account_id."'><button type='button'>詳細</button></a></td></tr>\n";
   ...
   if(is_readable('./situmon_list.html')) {

   $fp=fopen('./situmon_list.html','r');
