<?php
  ...
  $jukousha_line.="<tr><td>".$jukousha_account_id."</td><td>".$jukousha_bango."</td><td><a href ='./jukousha_touroku_2.php?targetID=".$jukousha_account_id."'>$jukousha_mei</a></td><td><a href='./jukousha_shousai.php?targetID=".$jukousha_account_id."'><button type='button'>詳細</button></a></td></tr>\n";
          }
