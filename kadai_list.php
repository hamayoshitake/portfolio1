<?php
    ...
    $kadai_line="";
     ...
     foreach ($result as $row) {
      ...
      $kadai_ki=$row['kadai_ki'];
        ...
        $kadai_line.="<tr><td>".$kadai_account_id."</td><td>$kadai_mei</td><td><a href='./kadai_list2.php'><button type='button'>受講者</button></a></td></tr>\n";
         }
        $result = null;
  }
    ...
    if(is_readable('./kadai_list.html')) {

      $fp=fopen('./kadai_list.html','r');
